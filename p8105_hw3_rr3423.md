...
Fridays, **coffee ice cream** is ordered slightly earlier than **pink
lady apples**. In addition, **coffee ice cream** is ordered earliest in
the day on Fridays when compared to the rest of the week. **Pink lady
apples** are ordered earliest in the day on Mondays. **Coffee ice
cream** is ordered latest in the day on Tuesdays. **Pink lady apples**
are ordered latest in the day on Wednesdays.
...
### Constructing a dataset and spaghetti plot limited to Excellent responses which contains year, state, and a variable that averages the data\_value across locations within a state.
...
Looking at this spaghetti plot, it seems that the average data\_value
...
Between 2006 and 2010, the distributions of data values for poor
responses are pretty similar, though the 2010 distribution is slightly
skewed in comparison to the 2006. The distributions of data values for
fair responses are similar, though the 2010 distribution seems to have a
wider range of data values. The distributions of data value for good
responses are slightly similar with similar median values. The
distributions of data values for very good responses are different
between 2006 and 2010, with the 2010 distribution having a higher median
data value. The distributions of data values for excellent responses are
similar to each other with similar median values, though they are both
slightly skewed.
...
**lowest on Saturdays** compared to the rest of the week. The total
activity in minutes is **highest on Fridays** compared to the rest of
the week. The total activity for Wednesdays, Thursdays, and Fridays are
